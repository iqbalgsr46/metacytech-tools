      ...
      <div className="w-full sm:max-w-[420px] bg-[#eff5f4] h-[100dvh] max-h-[100dvh] sm:h-[840px] sm:max-h-[840px] sm:rounded-[36px] overflow-hidden relative flex flex-col justify-between shadow-2xl">
        ...
        <div className="w-full flex-shrink-0">
          ...
          <div className="w-full px-4 mb-2 flex items-center justify-between gap-2.5 relative">
            ...
            {/* Receiver Card */}
            <div className="flex-1 h-[120px] bg-[#e1edea] rounded-[22px] p-2 flex flex-col items-center justify-center text-center shadow-xs border border-[#d2deda]">
              <div className="w-10 h-10 rounded-full bg-[#118EEA] flex items-center justify-center mb-1.5 shadow-xs overflow-hidden p-1">
                <svg viewBox="90 -111.5 332 332" className="w-full h-full" fill="none">
                  <circle cx="256" cy="54.5" r="166" fill="#118EEA" />
                  <g fill="#FFFFFF" fillRule="evenodd">
                    <path d="M151,82.84c7.26.52,15.72-5.12,18.7-8.34,10.36-11.21,10.61-27.42.18-39.16-3.88-4.37-13-9.2-18.77-8.52H130.22V82.77l20.83.07ZM142,70.72V38.87a75,75,0,0,1,9.82,0,15.22,15.22,0,0,1,7.13,2.76c12,8.2,7,27.75-7.33,29.06A71.77,71.77,0,0,1,142,70.72Z" />
                    <path d="M198.19,82.93h11.87c0-2.52-.32-10.23.11-12.06h23.54l.08,12.05h11.89c-.06-6.68,0-13.35,0-20,0-5.7.53-13.86-1-18.92a23.63,23.63,0,0,0-45.49-.23c-1.59,5.2-1.05,13.15-1.05,18.94,0,6.68-.15,13.53,0,20.19Zm11.88-24.18c-.08-5-.59-10.42,1.76-14.19a11.71,11.71,0,0,1,20.23,0c2.33,4,1.77,9.08,1.73,14.17Z" />
                    <path d="M266.57,48.67,266.4,57c0,7-.34,20.07,0,25.76h11.64c.27-4-.42-32.41.31-33.32,0-5.52,5.77-10.66,11.59-10.68A11.62,11.62,0,0,1,298.06,42c1.48,1.35,3.75,4.43,3.71,7.54.54.31.11,30,.28,33.29H313.7l-.09-33.95c.29-2.66-1.31-6.77-2.34-8.85A23.56,23.56,0,0,0,269,39.67C268,41.72,266.32,45.94,266.57,48.67Z" />
                    <path d="M334.39,82.94H346.3V70.88h23.63l.07,12h11.91V63c0-6,.5-13.48-1-18.91a23.62,23.62,0,0,0-45.49-.25c-1.6,5.36-1.06,13.05-1.06,19,0,6.72-.07,13.48,0,20.2Zm11.92-24.19c-.07-5-.6-10.35,1.75-14.2a11.61,11.61,0,0,1,10.15-5.77,11.79,11.79,0,0,1,10.08,5.82c2.32,4,1.77,9,1.71,14.16Z" />
                  </g>
                </svg>
              </div>
              <p className="font-bold text-[13px] text-[#1a1c1e] tracking-tight truncate w-full max-w-[130px]">
